...
| CI | Preserve all required tests/scans, 14-day reports, digest verification and USD 5/month Actions cost controls. [Cleanup PR #2](https://github.com/christiankfoury/llmops-platform/pull/2) tracks current-revision CI and merged-main verification; preparation is not complete until both pass. |

...
| Main branch | Require PRs, up-to-date CI, no additional reviewer, administrator enforcement, no bypass/force pushes/deletion. Settings readback pending. |
...
| CI | Preserve all required tests/scans, 14-day reports, digest verification and USD 5/month Actions cost controls. Candidate/main CI pending. |

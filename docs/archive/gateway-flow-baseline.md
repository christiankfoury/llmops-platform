> Historical example keys below are expressed as shell variables. Original literal
> placeholders remain in Git history; no live credential was present.

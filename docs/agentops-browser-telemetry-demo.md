# AgentOps telemetry demonstration
...
[Integration contract](agentops-integration.md) · [Historical browser evidence](archive/agentops-browser-telemetry-demo-baseline.md)
